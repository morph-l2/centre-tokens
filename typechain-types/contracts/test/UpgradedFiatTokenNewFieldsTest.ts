...
export interface UpgradedFiatTokenNewFieldsTestInterface
  ...
  functions: {
    ...
    "initV2(bool,address,uint256)": FunctionFragment;
    "initialize(string,string,string,uint8,address,address,address,address)": FunctionFragment;
    "initialize(string,string,string,uint8,address,address,address,address,bool,address,uint256)": FunctionFragment;
    ...
    "newBool()": FunctionFragment;
    "newUint()": FunctionFragment;
...
export interface UpgradedFiatTokenNewFieldsTest extends BaseContract {
  ...
  functions: {
    ...
    initV2(
      _newBool: PromiseOrValue<boolean>,
      _newAddress: PromiseOrValue<string>,
      _newUint: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    newBool(overrides?: CallOverrides): Promise<[boolean]>;

    newUint(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  estimateGas: {
    ...
    newBool(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    newBool(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    newUint(overrides?: CallOverrides): Promise<PopulatedTransaction>;
